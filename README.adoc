...
Now, you will need to update the [hotspot=accessor-ID file=1]`accessor` in the `columns` constant.
...
----
[role="edit_command_text"]
Change [hotspot=accessor-ID file=1]`accessor` to `accessor: "popularity"`.
