...
Then, point your browser to the web application root http://localhost:9080/app[http://localhost:8080^] to see the following output:
...
Navigate to the http://localhost:8080[http://localhost:8080^] URL to view your frontend application.
...
Whenever you change and build your React implementation, the frontend application at http://localhost:8080 reflects the changes automatically. You can visit the URL to manually check whether the artist JSON was consumed correctly. You can rebuild only your React frontend by running the following command:
