...
Fetchdata.js
[source, javascript, linenums, role='code_column hide_tags=axios-library,react-table,columns-info,get-posts,mount-posts,render-posts']
----
...
Fetchdata.js
[source, javascript, linenums, role='code_column hide_tags=react-table,columns-info,mount-posts,render-posts']
----
include::finish/src/main/frontend/src/Components/Fetchdata.js[]
----
...
Next add the [hotspot=columns-info]`columns` variable. Lastly, Add the 
