...
Next, you will create the component that will define the states and properties of your react webpage. 
...
Lastly, add the [hotspot=convert-data]`convertData` function which will manipulate the JSON data, to allow it to be accessed.
